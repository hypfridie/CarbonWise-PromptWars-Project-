...
abstract class Hilt_EditProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditProfileFragment() {
    super();
  }

  Hilt_EditProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditProfileFragment_GeneratedInjector) this.generatedComponent()).injectEditProfileFragment(UnsafeCasts.<EditProfileFragment>unsafeCast(this));
    }
  }
