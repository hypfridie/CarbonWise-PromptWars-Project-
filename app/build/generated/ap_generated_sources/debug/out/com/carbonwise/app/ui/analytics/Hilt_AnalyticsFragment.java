...
abstract class Hilt_AnalyticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnalyticsFragment() {
    super();
  }

  Hilt_AnalyticsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnalyticsFragment_GeneratedInjector) this.generatedComponent()).injectAnalyticsFragment(UnsafeCasts.<AnalyticsFragment>unsafeCast(this));
    }
  }
