...
abstract class Hilt_TrackFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TrackFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrackFragment_GeneratedInjector) this.generatedComponent()).injectTrackFragment(UnsafeCasts.<TrackFragment>unsafeCast(this));
    }
  }
