...
abstract class Hilt_ChallengesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChallengesFragment() {
    super();
  }

  Hilt_ChallengesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChallengesFragment_GeneratedInjector) this.generatedComponent()).injectChallengesFragment(UnsafeCasts.<ChallengesFragment>unsafeCast(this));
    }
  }
