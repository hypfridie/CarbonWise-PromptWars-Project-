...
public final class ItemAchievementBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView iconAchievement;
  ...
  private ItemAchievementBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView iconAchievement, @NonNull ImageView imageLock,
  ...
  public static ItemAchievementBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.icon_achievement;
      ImageView iconAchievement = ViewBindings.findChildViewById(rootView, id);
      if (iconAchievement == null) {
        break missingId;
      }
      ...
      return new ItemAchievementBinding((MaterialCardView) rootView, iconAchievement, imageLock,
